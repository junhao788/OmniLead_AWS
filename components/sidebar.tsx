...
export function Sidebar({
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col border-border bg-sidebar lg:h-screen lg:w-64 lg:border-r">
      <div className="relative border-b border-border px-5 py-4" ref={dropdownRef}>
        <button
          onClick={() => setIsOpen((prev) => !prev)}
          className="flex w-full items-center gap-3 rounded-xl border border-border bg-sidebar-accent/35 p-3 text-left hover:bg-sidebar-accent/80 hover:border-primary/40 transition-all focus:outline-none focus:ring-2 focus:ring-primary/30"
        ...
        {isOpen && (
          <div className="absolute left-5 right-5 top-full z-50 mt-1 max-h-80 flex flex-col rounded-xl border border-border bg-popover p-2 shadow-xl animate-in fade-in slide-in-from-top-1 duration-150">
            <div className="relative mb-2 flex items-center">
              ...
              <input
                ...
                className="w-full rounded-lg border border-border bg-secondary pl-9 pr-3 py-1.5 text-xs text-foreground placeholder:text-muted-foreground focus:border-primary focus:outline-none"
                autoFocus
              />
            </div>

            <div className="flex-1 overflow-y-auto max-h-48 flex flex-col gap-1 pr-0.5">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <span className="block truncate font-medium text-foreground text-[13px]">{p.name}</span>
